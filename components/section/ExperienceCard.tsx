...
export const ExperienceCard = ({ experience }: ExperienceCardProps) => {
  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute inset-0 bg-linear-to-r from-gray-800/50 to-gray-900/50 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10" />
      ...
      <div className="relative bg-gray-900/50 border border-gray-700 rounded-xl p-6 hover:border-gray-600 transition-all duration-300 backdrop-blur-sm">
        ...
        <div className="mb-4">
          ...
          >
            ...
            <span className="text-sm font-semibold text-gray-300">Missions</span>
          </TextAnimation>
        ...
        {experience.actuel && (
          <div className="absolute top-4 right-4 flex items-center gap-2">
            <span className="text-xs font-semibold text-green-400">En cours</span>
